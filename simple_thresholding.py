...
# be set to 255 
ret, thresh1_img1 = cv2.threshold(img1, 90, 255, cv2.THRESH_BINARY) 
ret, thresh1_img2 = cv2.threshold(img2, 90, 255, cv2.THRESH_BINARY)

ret, thresh2_img1 = cv2.threshold(img1, 90, 255, cv2.THRESH_BINARY_INV) 
ret, thresh2_img2 = cv2.threshold(img2, 90, 255, cv2.THRESH_BINARY_INV) 

ret, thresh3_img1 = cv2.threshold(img1, 90, 255, cv2.THRESH_TRUNC) 
ret, thresh3_img2 = cv2.threshold(img2, 90, 255, cv2.THRESH_TRUNC) 

ret, thresh4_img1 = cv2.threshold(img1, 90, 255, cv2.THRESH_TOZERO) 
ret, thresh4_img2 = cv2.threshold(img2, 90, 255, cv2.THRESH_TOZERO) 

ret, thresh5_img1 = cv2.threshold(img1, 90, 255, cv2.THRESH_TOZERO_INV) 
ret, thresh5_img2 = cv2.threshold(img2, 90, 255, cv2.THRESH_TOZERO_INV) 
