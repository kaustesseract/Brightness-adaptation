...
image_1 = cv.imread("img_6_1.jpg").astype(np.float64) / 255 # reading the image and converting into float values
...
image_2 = cv.imread("img_6_2.jpg").astype(np.float64) / 255  # reading the image and converting into float values
